...
Today Kolmanskop is a ghost town that visitors can tour.` }
  ...
  questions: [
    ...
    { passageId: "bp1", question: "What was Maya's first idea?", correct: 2, qType: "supporting", choices: ["A cardboard castle","A target practice game","A self-stirring cereal bowl","A rubber band slingshot"], explanation: "Her best idea was a cereal bowl that didn't stir." },
    { passageId: "bp1", question: "What change did Theo make that helped the launcher work?", correct: 0, qType: "supporting", choices: ["He flipped a spoon so it cupped the marble.","He replaced the rubber band with tape.","He added a second cardboard tube.","He moved the launcher closer to the refrigerator."], explanation: "Flipping the spoon to cup the marble fixed it." },
    { passageId: "bp1", question: "Based on the passage, how does Theo most likely feel by the end?", correct: 2, qType: "inference", choices: ["Annoyed at being asked to help.","She should have picked a better idea.","Proud of her but not showing it directly.","He wishes he'd built his own invention."], explanation: "He pretends not to be impressed but keeps helping." },
    { passageId: "bp1", question: "'snorted' in the second paragraph suggests Theo was", correct: 1, qType: "vocab", choices: ["surprised","amused or teasing","angry","trying not to wake their mother"], explanation: "A snort here shows light teasing." },
    { passageId: "bp1", question: "What is the author's purpose?", correct: 3, qType: "organization", choices: ["To explain how to build a marble launcher.","To warn about messy kitchen projects.","To describe Invention Fair rules.","To show how a small bit of help turns frustration into success."], explanation: "The author celebrates how Theo's small help transforms Maya's project." },
    { passageId: "bp2", question: "What is the passage mostly about?", correct: 2, qType: "mainIdea", choices: ["Bees and butterflies pollinate flowers during the day.","Most flowers close their petals at night.","How and why some flowers bloom only after dark.","Different colors of flowers around the world."], explanation: "The passage centers on night-blooming flowers — how and why." },
    { passageId: "bp2", question: "Why are most night-blooming flowers white or pale?", correct: 1, qType: "supporting", choices: ["Colors fade in cold night air.","Pale petals reflect moonlight and are easier to see in the dark.","Bright colors would scare bats away.","White flowers produce more nectar."], explanation: "Pale petals reflect the little moonlight available." },
    { passageId: "bp2", question: "Which animals visit night-blooming flowers?", correct: 3, qType: "supporting", choices: ["Hummingbirds","Honeybees","Butterflies","Moths, bats, and certain beetles"], explanation: "The passage names moths, bats, and beetles as night pollinators." },
    { passageId: "bp2", question: "You can infer night-blooming plants probably", correct: 0, qType: "inference", choices: ["face less competition for pollinators than daytime flowers.","produce more seeds than daytime flowers.","cannot survive in hot climates.","are pollinated only by moths."], explanation: "Night blooming evolved partly to escape daytime competition." },
    { passageId: "bp2", question: "'carrying' in 'scents carrying for hundreds of feet' means", correct: 2, qType: "vocab", choices: ["lifting","holding","traveling or spreading","transporting by hand"], explanation: "Scents traveling/spreading through air." },
    { passageId: "bp2", question: "The author's tone is best described as", correct: 1, qType: "tone", choices: ["worried","curious and inviting","strictly factual","sad"], explanation: "The author invites readers to notice nature curiously." },
    { passageId: "bp3", question: "Best summary of Henson's life:", correct: 2, qType: "mainIdea", choices: ["He became a farmer in Maryland.","He sailed but was forgotten.","He overcame hardship to become a skilled Arctic explorer who helped reach the North Pole.","He worked with the Inuit to map Greenland."], explanation: "His journey from orphan to Arctic explorer and finally recognition." },
    { passageId: "bp3", question: "Who taught Henson to read charts and navigate by stars?", correct: 0, qType: "supporting", choices: ["A ship captain","Robert Peary","An Inuit guide","His father"], explanation: "The captain taught him." },
    { passageId: "bp3", question: "What did Henson learn from the Inuit?", correct: 3, qType: "supporting", choices: ["Ship repair","Map reading","Seal hunting","Sled-building, dog handling, and surviving on the ice"], explanation: "Inuit shared knowledge of sleds, dogs, and ice survival." },
    { passageId: "bp3", question: "Why did Henson not get proper credit for years?", correct: 1, qType: "supporting", choices: ["He never asked for credit.","History books gave most credit to Peary alone.","He returned to sailing and disappeared.","He couldn't prove he reached the Pole."], explanation: "History books for decades credited only Peary." },
    { passageId: "bp3", question: "'brutal' in 'brutal cold' means", correct: 2, qType: "vocab", choices: ["unfamiliar","interesting","extremely harsh","slightly chilly"], explanation: "'Brutal' here means extremely harsh." },
    { passageId: "bp3", question: "The author's purpose in the last paragraph is to", correct: 0, qType: "organization", choices: ["Show that Henson's contributions are now being remembered.","Explain how the Pole was finally mapped.","Criticize past history books.","Describe modern museum exhibits."], explanation: "The paragraph highlights his contemporary recognition." },
    { passageId: "bp4", question: "Main idea?", correct: 2, qType: "mainIdea", choices: ["Snowflakes are always six-sided because of cold air.","Scientists grow snowflakes in labs.","A snowflake's shape depends on its journey through the sky.","Every snowflake starts with a piece of ice."], explanation: "Shape comes from the journey through varying air." },
    { passageId: "bp4", question: "Every snowflake begins with...", correct: 1, qType: "supporting", choices: ["A drop of rain","A speck of dust","A grain of pollen","A piece of older ice"], explanation: "A speck of dust floating in a cloud." },
    { passageId: "bp4", question: "What kind of air produces long, needle-shaped flakes?", correct: 3, qType: "supporting", choices: ["Warm and wet","Warm and dry","Cold and wet","Cold and dry"], explanation: "Colder, drier air produces needles." },
    { passageId: "bp4", question: "Two flakes falling the same day in the same town", correct: 0, qType: "inference", choices: ["may still look very different because of slightly different paths.","will look identical to each other.","will be the same shape if they land at the same time.","must be the same temperature when they form."], explanation: "Different paths → different shapes, even nearby." },
    { passageId: "bp4", question: "'hexagons' refers to shapes with", correct: 2, qType: "vocab", choices: ["four sides","five sides","six sides","eight sides"], explanation: "Hexagons have six sides." },
    { passageId: "bp4", question: "The author's purpose is to", correct: 1, qType: "organization", choices: ["Convince readers snow is dangerous.","Explain how snowflakes form and why they look different.","Compare snowflakes with raindrops.","Describe one scientist's life."], explanation: "Primarily explanatory: how and why snowflakes vary." },
    { passageId: "bp5", question: "Main lesson?", correct: 1, qType: "mainIdea", choices: ["Older cousins always know best.","Working together sometimes means giving up part of what you want.","Treehouses should be built in groups of four.","Reading and snacking go well together."], explanation: "Each cousin compromises to fit everyone." },
    { passageId: "bp5", question: "Why did the cousins struggle to decide?", correct: 2, qType: "supporting", choices: ["Their parents wouldn't let them buy supplies.","The platform was too small for anything.","Four cousins but only enough room for some ideas.","Ezra refused to vote."], explanation: "Big but not huge; four people = tie possible." },
    { passageId: "bp5", question: "How did Priya and Marcus solve part of the problem?", correct: 0, qType: "supporting", choices: ["They combined the reading corner and snack station.","They skipped the snack station.","They let Jordan have a small lookout tower.","They asked Ezra to decide."], explanation: "Priya proposed combining; Marcus agreed." },
    { passageId: "bp5", question: "What changed Jordan's mind about the tower?", correct: 3, qType: "supporting", choices: ["His cousins said it was dangerous.","The platform was too weak.","He realized a tower would have a bad view.","He pictured himself sitting alone in it."], explanation: "Imagining sitting alone made the tower less appealing." },
    { passageId: "bp5", question: "'victory' in 'felt like a victory' suggests", correct: 2, qType: "vocab", choices: ["They won a game against another team.","They had defeated Ezra's quiet suggestion.","The disagreement felt friendly because the bigger problem was solved.","Jordan finally got his lookout tower."], explanation: "Small arguments after working through the big issue feel triumphant." },
    { passageId: "bp5", question: "The author's purpose is to", correct: 1, qType: "organization", choices: ["Teach how to build a real treehouse.","Show how compromise leads to a better group decision.","Explain why families often disagree.","Warn against letting younger kids vote."], explanation: "The story models cooperative compromise." },
    { passageId: "bp6", question: "What is the passage mostly about?", correct: 1, qType: "mainIdea", choices: ["The history of diamond mining around the world.","How a once-rich desert town rose, fell, and was claimed by the sand.","Why German settlers came to southern Africa.","Animals that live in abandoned desert towns."], explanation: "The passage traces Kolmanskop's discovery, growth, decline, and burial." },
    { passageId: "bp6", question: "What did a railway worker find in 1908?", correct: 0, qType: "supporting", choices: ["A diamond glittering in the sand.","Gold in nearby rocks.","An underground river.","A forgotten village."], explanation: "Something glittering turned out to be a diamond." },
    { passageId: "bp6", question: "Which of these did Kolmanskop have?", correct: 2, qType: "supporting", choices: ["An airport and university.","A large harbor for ships.","A hospital with the first X-ray machine in southern Africa.","A famous diamond museum."], explanation: "X-ray machine: first in southern Africa." },
    { passageId: "bp6", question: "Why did people leave Kolmanskop in the 1930s?", correct: 3, qType: "supporting", choices: ["Sand became too dangerous.","The government closed the town.","Disease spread.","Larger diamond deposits were discovered farther south."], explanation: "Bigger deposits south drew miners away." },
    { passageId: "bp6", question: "'wasted no time' in 'the desert wasted no time' means", correct: 1, qType: "vocab", choices: ["was careful and slow.","acted quickly.","destroyed nothing important.","became completely silent."], explanation: "Idiom for acting quickly." },
    { passageId: "bp6", question: "The tone of the final paragraph is", correct: 2, qType: "tone", choices: ["Cheerful and excited.","Angry and critical.","Reflective and a little sad.","Frightened and uneasy."], explanation: "A 'ghost town' with sand-filled hallways evokes wistful sadness." }
  ]
};
